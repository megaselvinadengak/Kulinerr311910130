...
public class AdapterCard extends RecyclerView.Adapter<AdapterCard.CardViewHolder> {
    ...
    @NonNull
    @Override
    public CardViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int
            viewType) {
        View view =
    ...
    @Override
    public void onBindViewHolder(@NonNull CardViewHolder holder, int
            position) {
        ...
        Glide.with(holder.itemView.getContext()).load(kulinermodel.getFoto()).into(
                holder.ivKuliner);
